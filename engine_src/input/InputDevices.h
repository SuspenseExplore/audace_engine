...
namespace Audace {
	...
	public:
		enum InputName {
			...
			LEFT_THUMBREST_TOUCH, LEFT_GRIP_POSE, LEFT_AIM_POSE, LEFT_AIM_VIEW_POSE,
		...
		static constexpr InputName booleanInputs[] = {
				LEFT_X_CLICK, LEFT_X_TOUCH, LEFT_Y_CLICK, LEFT_Y_TOUCH, LEFT_MENU_CLICK,
				LEFT_TRIGGER_TOUCH, LEFT_THUMBSTICK_CLICK, LEFT_THUMBSTICK_TOUCH,
				LEFT_THUMBREST_TOUCH,
				RIGHT_A_CLICK, RIGHT_A_TOUCH, RIGHT_B_CLICK, RIGHT_B_TOUCH, RIGHT_SYSTEM_CLICK,
				RIGHT_TRIGGER_TOUCH, RIGHT_THUMBSTICK_CLICK, RIGHT_THUMBSTICK_TOUCH,
