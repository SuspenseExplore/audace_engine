...
bool OpenxrContext::registerActions() {
	...
	XR_ERROR_BAIL("xrStringToPath", xrStringToPath(instance, "/user/hand/right", &rightHandPath));
	...
	{
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::LEFT_AIM_VIEW_POSE;
		XrActionCreateInfo actionInfo{XR_TYPE_ACTION_CREATE_INFO};
		actionInfo.actionType = XR_ACTION_TYPE_POSE_INPUT;
		strcpy(actionInfo.actionName, "left_aim_view");
		strcpy(actionInfo.localizedActionName, "Left hand aim view");
		actionInfo.countSubactionPaths = 1;
		actionInfo.subactionPaths = &leftHandPath;
	...
	{
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::LEFT_THUMBSTICK_X;
		XrActionCreateInfo actionInfo{XR_TYPE_ACTION_CREATE_INFO};
		actionInfo.actionType = XR_ACTION_TYPE_FLOAT_INPUT;
		strcpy(actionInfo.actionName, "left_stick_x");
		strcpy(actionInfo.localizedActionName, "Left Stick X");
		actionInfo.countSubactionPaths = 1;
		actionInfo.subactionPaths = &leftHandPath;
	...
	{
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::LEFT_THUMBSTICK_Y;
		XrActionCreateInfo actionInfo{XR_TYPE_ACTION_CREATE_INFO};
		actionInfo.actionType = XR_ACTION_TYPE_FLOAT_INPUT;
		strcpy(actionInfo.actionName, "left_stick_y");
		strcpy(actionInfo.localizedActionName, "Left Stick Y");
		actionInfo.countSubactionPaths = 1;
		actionInfo.subactionPaths = &leftHandPath;
	...
	// right hand
	{
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::RIGHT_GRIP_POSE;
		XrActionCreateInfo actionInfo{XR_TYPE_ACTION_CREATE_INFO};
		actionInfo.actionType = XR_ACTION_TYPE_POSE_INPUT;
	...
	}
	{
		...
		XrActionCreateInfo actionInfo{XR_TYPE_ACTION_CREATE_INFO};
		actionInfo.actionType = XR_ACTION_TYPE_BOOLEAN_INPUT;
		strcpy(actionInfo.actionName, "a_button_click");
		strcpy(actionInfo.localizedActionName, "A Button Click");
		actionInfo.countSubactionPaths = 1;
		actionInfo.subactionPaths = &rightHandPath;
	...
	{
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::RIGHT_THUMBSTICK_X;
		XrActionCreateInfo actionInfo{XR_TYPE_ACTION_CREATE_INFO};
		actionInfo.actionType = XR_ACTION_TYPE_FLOAT_INPUT;
		strcpy(actionInfo.actionName, "right_stick_x");
		strcpy(actionInfo.localizedActionName, "Right Stick X");
		actionInfo.countSubactionPaths = 1;
		actionInfo.subactionPaths = &rightHandPath;
	...
	}
	{
		...
		XrActionCreateInfo actionInfo{XR_TYPE_ACTION_CREATE_INFO};
		actionInfo.actionType = XR_ACTION_TYPE_FLOAT_INPUT;
		strcpy(actionInfo.actionName, "right_stick_y");
		strcpy(actionInfo.localizedActionName, "Right Stick Y");
		actionInfo.countSubactionPaths = 1;
		actionInfo.subactionPaths = &rightHandPath;
...
bool OpenxrContext::processActions(XrTime displayTime) {
	...
	if (poseInputHandlers.find(Audace::OculusTouchController::LEFT_AIM_VIEW_POSE) != poseInputHandlers.end()) {
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::LEFT_AIM_VIEW_POSE;
		XrActionStateGetInfo getInfo{XR_TYPE_ACTION_STATE_GET_INFO};
		getInfo.action = actions[name];
		...
		if (poseState.isActive == XR_TRUE && poseInputHandlers.find(name) != poseInputHandlers.end()) {
			XrSpaceLocation location{XR_TYPE_SPACE_LOCATION};
			xrLocateSpace(leftAimViewSpace, xrViewSpace, displayTime, &location);
			Audace::Pose pose;
			pose.position = glm::vec3(location.pose.position.x, location.pose.position.y, location.pose.position.z);
			pose.orientation = glm::quat(location.pose.orientation.w, location.pose.orientation.x, location.pose.orientation.y, location.pose.orientation.z);
			poseInputHandlers[name](Audace::PoseInputEvent(pose, true, displayTime));
	...
	if (floatInputHandlers.find(Audace::OculusTouchController::LEFT_THUMBSTICK_X) != floatInputHandlers.end()) {
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::LEFT_THUMBSTICK_X;
	...
	if (floatInputHandlers.find(Audace::OculusTouchController::LEFT_THUMBSTICK_Y) != floatInputHandlers.end()) {
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::LEFT_THUMBSTICK_Y;
		std::function<void(Audace::FloatInputEvent)> handler = floatInputHandlers[name];
		XrActionStateGetInfo getInfo{XR_TYPE_ACTION_STATE_GET_INFO};
		getInfo.action = actions[name];
	...
	if (poseInputHandlers.find(Audace::OculusTouchController::RIGHT_GRIP_POSE) != poseInputHandlers.end()) {
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::RIGHT_GRIP_POSE;
		XrActionStateGetInfo getInfo{XR_TYPE_ACTION_STATE_GET_INFO};
		getInfo.action = actions[name];
		...
		if (poseState.isActive == XR_TRUE && poseInputHandlers.find(name) != poseInputHandlers.end()) {
			XrSpaceLocation location{XR_TYPE_SPACE_LOCATION};
			xrLocateSpace(rightHandPoseSpace, xrWorldSpace, displayTime, &location);
			Audace::Pose pose;
			pose.position = glm::vec3(location.pose.position.x, location.pose.position.y, location.pose.position.z);
			pose.orientation = glm::quat(location.pose.orientation.w, location.pose.orientation.x, location.pose.orientation.y, location.pose.orientation.z);
			poseInputHandlers[name](Audace::PoseInputEvent(pose, true, displayTime));
	...
	if (floatInputHandlers.find(Audace::OculusTouchController::RIGHT_THUMBSTICK_X) != floatInputHandlers.end()) {
		Audace::OculusTouchController::InputName name = Audace::OculusTouchController::RIGHT_THUMBSTICK_X;
		std::function<void(Audace::FloatInputEvent)> handler = floatInputHandlers[name];
		XrActionStateGetInfo getInfo{XR_TYPE_ACTION_STATE_GET_INFO};
		getInfo.action = actions[name];
