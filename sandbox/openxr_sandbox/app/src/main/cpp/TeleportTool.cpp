...
void TeleportTool::handlePoseEvent(au::PoseInputEvent e)
{
	if (e.changed)
	{
		handPose = e.state;
...
void TeleportTool::handleSqueezeEvent(au::FloatInputEvent e)
{
...
void TeleportTool::handleStickMotionEvent(au::FloatInputEvent e)
{
	if (!primed)
	{
...
void TeleportTool::renderWorldSpace(au::Scene *scene)
{
