...
ProcCityScene::ProcCityScene(Audace::BaseAppController *controller)
	: Scene(controller)
{
	strcpy(sceneWritePath, "D:/audace_engine/sandbox/assets/scenes/MainScene.json");
}

void ProcCityScene::loadAssets(Audace::IFileAccess *fileLoader)
{
...
void ProcCityScene::reloadScene()
{
...
void ProcCityScene::loadModel(std::string path, std::string filename)
{
}

void ProcCityScene::setClearColor(glm::vec4 color)
{
	clearColor = color;
}

void ProcCityScene::setAmbientLight(glm::vec4 color)
{
	ambientColor = color;
}

void ProcCityScene::setLight(Audace::LightType type, Audace::Sprite *sprite)
{
...
Audace::TypedLight *ProcCityScene::getLight(const std::string &name)
{
	return lights[name];
}

void ProcCityScene::setCamera(Audace::BaseCamera *camera)
{
	this->camera = camera;
}

Audace::BaseCamera *ProcCityScene::getCamera()
{
	return camera;
}

void ProcCityScene::teleport(glm::vec3 pos)
{
	camera->setOriginPos(pos);
}

void ProcCityScene::renderUi()
{
...
void ProcCityScene::disposeAssets()
{
}